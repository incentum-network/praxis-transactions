...
export class CoinToOutputTransaction extends BaseTransaction {
    public static type = TransactionTypes.CoinToOutput as number;
    ...
    public static getSchema(): Transactions.schemas.TransactionSchema {
        return schemas.extend(schemas.transactionBaseSchema, {
            ...
            required: ["asset"],
            properties: {
                type: { transactionType: CoinToOutputTransaction.type },
    ...
    public serialize():  ByteBuffer {
        const { data } = this;
        const payload = data.asset.payload as CoinToOutputPayload;  
